...
In an effot to improve the current statge of \ac{cap} diagnosis and detection, this thesis is intended to provide a multiparameteric \ac{mri} \acs{cad} system. 
