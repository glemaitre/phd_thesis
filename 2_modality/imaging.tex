...
\centering
	\hspace*{\fill}
	\subfigure[\acs*{t2w}-\acs*{mri} slice of an healthy prostate acquire with a \SI{1.5}{\tesla} \acs*{mri}. The blue contour represents the \acs*{cg} while the \acs*{pz} corresponds to the green contour.]{\label{subfig:t2whealthy}\includegraphics[width=0.3\linewidth]{2_modality/figures/t2w/t2w_healthy.eps}} \hfill
	\subfigure[\acs*{t2w}-\acs*{mri} slice of a prostate with a \acs*{cap} highlighted in the \acs*{pz} using a \SI{3}{\tesla} \acs*{mri} scanner.]{\label{subfig:t2wcancerpz}\includegraphics[width=0.3\linewidth]{2_modality/figures/t2w/t2w_cancer_pz.eps}} \hfill
	\subfigure[\acs*{t2w}-\acs*{mri} slice of a prostate with a \acs*{cap} highlighted in the \acs*{cg} using a \SI{3}{\tesla} \acs*{mri} scanner.]{\label{subfig:t2wcancercg}\includegraphics[width=0.3\linewidth]{2_modality/figures/t2w/t2w_cancer_cg.eps}}
	\hspace*{\fill}
...
The distinction between healthy and \ac{cap} in \ac{dw}-\ac{mri} is based on the following a physiological bases.
...
\begin{figure}
	\centering
	\hspace*{\fill}
	\subfigure[Illustration of an \acs*{mrsi} spectrum of an healthy voxel acquired with a \SI{3}{\tesla} \acs*{mri}.]{\label{subfig:mrsihea}\includegraphics[width=0.45\linewidth]{2_modality/figures/mrsi/mrsi_healthy.eps}} \hfill
