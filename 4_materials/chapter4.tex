...
Furthermore, \citeauthor{varoquaux2015Software} in his article %\citetitle{varoquaux2015Software}
...
With respect to aforementioned discussion our intention with \nameref{chap:4} chapter is two fold: (i) use this chapter to position ourselves with respect to reproducible research; (ii) describe all the resources and outcomes from this thesis that allows our experiments be reproducible.
%% sik:
