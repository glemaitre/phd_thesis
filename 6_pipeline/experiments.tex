...
\begin{figure}
  ...
  \hfill
  \subfigure[\acs*{auc} = 0.784]{\label{fig:pat778}\includegraphics[width=.45\textwidth]{6_pipeline/figures/examples/patient_778.pdf}}
  \hfill
  \subfigure[\acs*{auc} = 0.1041]{\label{fig:pat1036}\includegraphics[width=.45\textwidth]{6_pipeline/figures/examples/patient_1041.pdf}}
  \hspace*{\fill}
