...
\include{2_MRI_principles/aims}						% aims of the project

\include{3_review/stateofart}			
\include{4_materials/XYZ}	
\include{5_normalization/XYZ}
\include{6_CADeCADx/XYZ}
...
\bibliography{9_backmatter/literature_review}
